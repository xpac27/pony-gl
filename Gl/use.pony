...
use @glCompileShaderIncludeARB[None](shader: GLuint, count: GLsizei, path: Pointer[Pointer[GLchar] tag] tag, length: Pointer[GLint] tag)
...
use @glCreateShaderProgramv[GLuint](type': GLenum, count: GLsizei, strings: Pointer[Pointer[GLchar] tag] tag)
...
use @glDebugMessageCallback[None](callback: Pointer[None], userParam: GLDebugUserObject)
...
use @glGetUniformIndices[None](program: GLuint, uniformCount: GLsizei, uniformNames: Pointer[Pointer[GLchar] tag] tag, uniformIndices: Pointer[GLuint] tag)
...
use @glShaderSource[None](shader: GLuint, count: GLsizei, string: Pointer[Pointer[GLchar] tag] tag, length: Pointer[GLint] tag)
...
use @glTransformFeedbackVaryings[None](program: GLuint, count: GLsizei, varyings: Pointer[Pointer[GLchar] tag] tag, bufferMode: GLenum)
...
use @glGetBufferPointerv[None](target: GLenum, pname: GLenum, params: Pointer[Pointer[None] tag] tag)
use @glGetNamedBufferPointervEXT[None](buffer: GLuint, pname: GLenum, params: Pointer[Pointer[None] tag] tag)
use @glGetNamedBufferPointerv[None](buffer: GLuint, pname: GLenum, params: Pointer[Pointer[None] tag] tag)
use @glGetPointerIndexedvEXT[None](target: GLenum, index: GLuint, data: Pointer[Pointer[None] tag] tag)
use @glGetPointeri_vEXT[None](pname: GLenum, index: GLuint, params: Pointer[Pointer[None] tag] tag)
use @glGetPointerv[None](pname: GLenum, params: Pointer[Pointer[None] tag] tag)
use @glGetVertexArrayPointeri_vEXT[None](vaobj: GLuint, index: GLuint, pname: GLenum, param: Pointer[Pointer[None] tag] tag)
use @glGetVertexArrayPointervEXT[None](vaobj: GLuint, pname: GLenum, param: Pointer[Pointer[None] tag] tag)
use @glGetVertexAttribPointerv[None](index: GLuint, pname: GLenum, pointer: Pointer[Pointer[None] tag] tag)
